          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="{{route('User.edit')}}">Modifier Profil</button>
                  </li>
              </ul>
                ...
                <form  method="POST"  action="{{ route('User.update',$user->id) }}">
                    ...
                    @method('PUT')
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="prenom" type="text" class="form-control" id="fullName" value="{{ $user->nom}}">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="adresse" type="text" class="form-control" id="Address" value="{{ $user->addres}}">
                        </div>
                      </div>
