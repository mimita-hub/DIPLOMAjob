...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-heading">Gestions</li>

      <li class="nav-item">
        <a  class="nav-link collapsed" href="{{route('Universite.index')}}" class="btn btn-color-99CC5B "role="button" class="btn">  <i class="bi bi-mortarboard"></i>
            <span class="text-color-99CC5B">Universités</span>
          </a>
      </li><!-- End Profile Page Nav -->
      <li class="nav-item">
        <a  class="nav-link collapsed" href="{{route('Universite.index')}}" class="btn btn-color-99CC5B "role="button" class="btn">  <i class="bi bi-building"></i>
